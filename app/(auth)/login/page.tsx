    ...
    <div className="min-h-[calc(100vh-8rem)] flex items-center justify-center px-4 py-12 bg-gradient-to-br from-emerald-50/50 via-background to-teal-50/50 dark:from-emerald-950/20 dark:via-background dark:to-teal-950/20">
      <Card className="w-full max-w-md border-0 shadow-2xl shadow-emerald-500/5">
        <CardHeader className="text-center space-y-4">
          ...
          <CardDescription>Sign in to your DonateConnect account</CardDescription>
        </CardHeader>
        <CardContent>
          ...
          <div className="mt-6 text-center text-sm text-muted-foreground">
            ...
            <Link href="/register" className="font-semibold text-emerald-600 hover:text-emerald-700">Sign up</Link>
          </div>
          <div className="mt-4 p-3 rounded-lg bg-muted/50 text-xs text-muted-foreground">
            <p className="font-medium mb-1">Demo Accounts:</p>
            <p>Admin: admin@donateconnect.com</p>
            <p>Donor: rahul@example.com</p>
            <p>NGO: helping@example.com</p>
...
export default function LoginPage() {
  return (
    <Suspense fallback={<div className="min-h-[calc(100vh-8rem)] flex items-center justify-center"><Loader2 className="h-8 w-8 animate-spin text-emerald-600" /></div>}>
      <LoginForm />
    </Suspense>
  );
}
